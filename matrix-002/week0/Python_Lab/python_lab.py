...
square_dict = { i : i**2 for i in range(0,100)}
...
representation_dict =  { i:(i//base**2,(i//base)%base,i%base) for i in range(base*base*base) }
...
# def nextInts(L): return list(map(lambda i:i+1,L))
